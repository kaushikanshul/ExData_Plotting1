...
# Open te PNG file, plot the required content and close the file

png("plot2.png", width=480, height=480)
plot(DateTime, SelectData$Global_active_power, type="l", xlab="", ylab="Global Active Power (kilowatts)")
dev.off()